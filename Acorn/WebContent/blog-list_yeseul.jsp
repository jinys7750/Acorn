            ...
            <div class="col-12">
              <div class="media hover-style media-list">
                ...
                <div class="media-body">
                  ...
                  <a href="blog-detail.jsp" class="h4">Lorem ipsum dolor sit amet</a>
                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  <a class="btn btn-sm btn-theme" href="blog-detail.jsp" role="button">Read More</a>
                </div>
              </div>
              <div class="media hover-style media-list">
                <a href="blog-detail.jsp">
                  <div data-cover="img/blog/blog2.jpg" data-xs-height="250px" data-sm-height="200px" data-md-height="200px" data-lg-height="200px" data-xl-height="200px">
                  </div>
                </a>
                <div class="media-body">
                  <ul class="list-inline mb-1">
              ...
              <div class="media hover-style media-list">
                <a href="blog-detail.jsp">
                  <div data-cover="img/blog/blog3.jpg" data-xs-height="250px" data-sm-height="200px" data-md-height="200px" data-lg-height="200px" data-xl-height="200px">
                  </div>
                </a>
                <div class="media-body">
                  <ul class="list-inline mb-1">
              ...
              <div class="media hover-style media-list">
                <a href="blog-detail.jsp">
                  <div data-cover="img/blog/blog4.jpg" data-xs-height="250px" data-sm-height="200px" data-md-height="200px" data-lg-height="200px" data-xl-height="200px">
                  </div>
                </a>
                <div class="media-body">
                  <ul class="list-inline mb-1">
