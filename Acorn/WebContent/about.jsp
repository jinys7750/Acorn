		...
		<div class="row">
			<div class="col-md-8 mb-3">
				...
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
					Aspernatur, tempore, excepturi, voluptatum, fugiat velit maiores
					placeat qui cumque perferendis impedit non aliquid asperiores sit
					facere doloremque! Fugit, quam, cum, in libero asperiores
					necessitatibus neque nostrum consectetur iusto voluptatem incidunt
					odit ut fugiat architecto aliquid? Officiis, nemo, odio tempora aut
					omnis at fugit quidem porro et ad alias quibusdam voluptate
					veritatis repellendus consequuntur beatae hic voluptatum ab
					voluptatem impedit! Dolor, autem, assumenda, dolorem veritatis nemo
					numquam dignissimos veniam molestiae facere tempora laboriosam
					soluta. Ea, magnam ratione eligendi exercitationem quisquam
					aspernatur a dolore veritatis unde nihil inventore quia at debitis
					quasi nisi!</p>
				...
				<address>
					<strong>Mimity Store.</strong><br> 212 Lorem Ipsum. Dolor Sit,
					Amet<br> <abbr title="Phone">P:</abbr> +123-456-789
				</address>
				<address>
					<strong>Full Name</strong><br> <a href="mailto:cs@domain.tld">Owner
						Full Name</a>
				</address>
			</div>
			<div class="col-md-4">
